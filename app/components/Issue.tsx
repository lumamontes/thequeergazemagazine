          ...
          <div className="flex flex-wrap gap-6">
            <button
              ...
              className={`flex flex-col items-center hover:opacity-80 transition-opacity ${
                activePdf === project.pdf ? 'ring-2 ring-white' : ''
              }`}
            >
            ...
            {project.pdf2 && (
              <button
                ...
                className={`flex flex-col items-center hover:opacity-80 transition-opacity ${
                  activePdf === project.pdf2 ? 'ring-2 ring-white' : ''
                }`}
              >
                <div className="w-24 h-16 bg-gray-800 mb-2 overflow-hidden">
                  <iframe
            ...
            {project.pdf3 && (
              <button
                ...
                className={`flex flex-col items-center hover:opacity-80 transition-opacity ${
                  activePdf === project.pdf3 ? 'ring-2 ring-white' : ''
                }`}
              >
                <div className="w-24 h-16 bg-gray-800 mb-2 overflow-hidden">
                  <iframe
            ...
            {project.pdf4 && (
              <button
                ...
                className={`flex flex-col items-center hover:opacity-80 transition-opacity ${
                  activePdf === project.pdf4 ? 'ring-2 ring-white' : ''
                }`}
              >
                <div className="w-24 h-16 bg-gray-800 mb-2 overflow-hidden">
                  <iframe
